...
export default function LandingPage() {
  return (
    <div className="bg-slate-50 text-slate-900 antialiased overflow-x-hidden scroll-smooth">
      <nav className="fixed top-0 w-full flex justify-between items-center px-6 h-16 bg-white/80 backdrop-blur-md shadow-sm z-50">
        <div className="flex items-center gap-8">
          <Link href="/" className="text-xl font-bold text-blue-950 tracking-tight">Taqim</Link>
          <div className="hidden md:flex items-center gap-6">
            <Link className="text-sm font-medium tracking-tight text-slate-500 hover:text-blue-800 transition-colors" href="/#services">Services</Link>
            <Link className="text-sm font-medium tracking-tight text-slate-500 hover:text-blue-800 transition-colors" href="/#pricing">Pricing</Link>
            <Link className="text-sm font-medium tracking-tight text-slate-500 hover:text-blue-800 transition-colors" href="/#about">About</Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center">
                <Button variant="secondary" size="lg" href="/client" className="w-full sm:w-auto">
                  Get your report
                </Button>
                <Button variant="outline" size="lg" href="/report/1" className="w-full sm:w-auto bg-transparent border-none hover:bg-slate-100 text-blue-950">
                  View Sample Report
                </Button>
              </div>
      ...
      <footer className="w-full flex flex-col md:flex-row justify-between items-center px-12 py-12 gap-6 bg-slate-50 border-t border-slate-200" id="pricing">
        ...
        <div className="flex flex-wrap justify-center gap-8 text-xs tracking-wider uppercase text-slate-400">
          <Link className="hover:text-blue-700 transition-opacity" href="/#privacy">Privacy Policy</Link>
          <Link className="hover:text-blue-700 transition-opacity" href="/#terms">Terms of Service</Link>
          <Link className="hover:text-blue-700 transition-opacity" href="/#legal">Legal Notice</Link>
          <Link className="hover:text-blue-700 transition-opacity" href="/#contact">Contact</Link>
        </div>
      </footer>
    </div>
  );
